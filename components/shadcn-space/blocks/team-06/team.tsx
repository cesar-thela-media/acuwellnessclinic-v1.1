  ...
  return (
    <div className="w-full bg-white">
      <section className="relative isolate overflow-hidden bg-forest">
        <img
          src="/media/wp-content/uploads/2017/09/china-2263731_1280.jpg"
          alt=""
          className="absolute inset-0 !h-full w-full object-cover object-top"
        />
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-gradient-to-r from-forest/88 via-forest/70 to-forest/45"
        />
        <div className="site-container relative flex min-h-[22rem] flex-col justify-end py-14 md:min-h-[26rem] md:py-16">
          <PageTitle className="text-white">Our Team</PageTitle>
        </div>
      </section>
      ...
      {members.map((member, index) => (
        ...
        >
          <article className="site-container site-section grid grid-cols-1 items-start gap-8 md:gap-12 lg:grid-cols-[minmax(0,22rem)_1fr] lg:gap-16">
            <div
              className={cn(
            ...
            >
              <h2 className="bio_head font-heading text-xl font-semibold tracking-tight text-forest sm:text-2xl !m-0">
                {member.name}
              </h2>
