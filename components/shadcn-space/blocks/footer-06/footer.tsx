...
const Footer = () => {
  return (
    <footer className="site-footer w-full overflow-x-clip bg-white text-body">
      <div className="site-container site-footer-inner py-12 md:py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="flex min-w-0 flex-col gap-5">
            ...
            <p className="font-heading text-xs uppercase tracking-[0.16em] text-forest/55 !m-0">
              {site.tagline}
            </p>
            <div className="flex flex-col gap-2 pt-1">
              ...
              >
                <Phone size={18} className="text-olive shrink-0" aria-hidden="true" />
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-[14px] border border-forest/15 text-forest transition-colors hover:border-olive hover:text-olive"
              >
                <FacebookIcon />
              </a>
              <a
          ...
          <div className="flex min-w-0 flex-col gap-4">
            <div className="flex items-center gap-2 border-b border-forest/15 pb-2">
              <Calendar size={15} className="text-olive shrink-0" aria-hidden="true" />
            ...
            <div className="flex flex-col gap-2.5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="site-footer-link inline-flex items-center justify-between rounded-[14px] border border-olive bg-olive px-3.5 py-2.5 font-heading text-sm font-medium !text-white transition-all duration-200 hover:border-forest hover:bg-forest hover:!text-white"
              >
          ...
          <div className="flex min-w-0 flex-col gap-4">
            <div className="flex items-center gap-2 border-b border-forest/15 pb-2">
              <Clock size={15} className="text-olive shrink-0" aria-hidden="true" />
              <h3 className="font-heading text-xs font-semibold tracking-[0.16em] text-forest uppercase !m-0">
                Hours
              </h3>
            </div>
            <ul className="flex flex-col gap-1.5 font-heading text-sm leading-relaxed text-body !m-0 !list-none !p-0">
              {site.hours.map((row) => (
                <li key={row.day} className="flex items-baseline justify-between border-b border-forest/10 pb-1 last:border-0">
                  <span className="w-10 shrink-0 font-semibold text-forest">{row.day}:</span>
                  <span className="text-body text-right">{row.hours}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="flex min-w-0 flex-col gap-4">
            <div className="flex items-center gap-2 border-b border-forest/15 pb-2">
              <MapPin size={15} className="text-olive shrink-0" aria-hidden="true" />
              <h3 className="font-heading text-xs font-semibold tracking-[0.16em] text-forest uppercase !m-0">
                Visit
              </h3>
            </div>
            <div className="flex flex-col gap-1 font-heading text-sm leading-relaxed text-body">
            ...
            <div className="pt-2">
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-xs font-heading font-medium text-olive hover:text-forest transition-colors"
              >
