...
export const TwitterIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      d="M9.333 6.667 15.153 0h-1.38L8.72 5.86 4.687 0H0l6.107 8.613L0 15.333h1.38l5.347-6.04 4.28 6.04h4.687L9.333 6.667zm-1.893.78-.62-.86L1.873 1.04h2.12l3.993 5.54.62.86 5.167 7.167h-2.12l-4.214-5.84v-.32z"
      fill="currentColor"
    />
  </svg>
);
