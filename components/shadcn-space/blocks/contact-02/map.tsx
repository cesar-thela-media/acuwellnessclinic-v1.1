...
export default function MapBand() {
  return (
    <div className="w-full bg-white">
      <PageHero title="Map & Directions" image="/media/wp-content/uploads/2018/09/Blog1_image.jpg" />

      <section className="bg-white">
        <div className="site-container site-section grid grid-cols-1 items-start gap-10 lg:grid-cols-[minmax(0,20rem)_1fr] lg:gap-16">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl bg-olive/10 sm:aspect-[21/9]">
